...
import 'package:healthcare/crud.dart';
import 'package:healthcare/edit_page.dart';
...
class _ListPage extends State<ListPage> {
  ...
  Employee({required String uid, required employeename, required contact, required price}) {}
}